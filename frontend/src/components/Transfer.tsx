            ...
            {beneficiaries.length > 0 && (
              <div className="flex space-x-2 md:space-x-4 mb-6">
                <button
                  ...
                  className={`flex items-center px-3 md:px-4 py-2 rounded-lg font-medium text-sm ${
                    !showQuickTransfer
              ...
              <>
                ...
                <div className="mb-6">
                  ...
                  {selectedBeneficiary ? (
                    ...
                    <div
                      className="space-y-2 max-h-32 md:max-h-40 overflow-y-auto"
            ...
            {(searchedUser || selectedBeneficiary) && (
              <div className="space-y-4">
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center px-4 py-3 bg-blue-600 text-white rounded-md hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed font-medium text-sm"
                >
                  {loading ? (
          ...
          <div className="bg-white rounded-xl shadow-sm border p-4 md:p-6">
            ...
            {beneficiaries.length === 0 ? (
              <div className="text-center py-4 md:py-6">
                <Users className="h-6 md:h-8 w-6 md:w-8 text-gray-400 mx-auto mb-2" />
                <p className="text-gray-500 text-xs md:text-sm">No saved beneficiaries</p>
              </div>
            ) : (
              <div className="space-y-2 md:space-y-3">
                {beneficiaries.slice(0, 5).map((beneficiary) => (
                  <button
                    key={beneficiary.accountNumber}
                    className="w-full text-left p-2 md:p-3 border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500"
                    onClick={() => selectBeneficiary(beneficiary)}
                  >
